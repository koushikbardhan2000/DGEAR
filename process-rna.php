...
$rcode = "/var/www/DGEAR/rnaseq.R"; // Full path is required i.e. "/var/www/DGEAR/microarray.R"
...
header("Location: results-rna.php"); // header("Location: https://musing-bush-92495.pktriot.net/webtool/results.php");
exit();
?>