...
<head>
  ...
  <link rel="canonical" href="https://compbiosysnbu.in/DGEAR/analysis.php">
  <title>DGEAR-Web | Microarray Analysis</title>
</head>
...
<body>
  <div class="body-div">
        ...
        <form id="analysisForm" action="process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <a href="analysis-RNA.php" id="" class="change-btn">RNA-seq Analysis</a>
            </div>
